...
class SSD300(nn.Module):
    ...
    def detect_objects(self, predicted_locs, predicted_scores, min_score, max_overlap, top_k):
        ...
        for i in range(batch_size):
            ...
            decoded_locs = self.cxcy_to_xy(self.gcxgcy_to_cxcy(predicted_locs[i], self.priors_cxcy))  # (8732, 4), these are fractional pt. coordinates
...
class MultiBoxLoss(nn.Module):
    ...
    def cxcy_to_gcxgcy(self, cxcy, priors_cxcy):
        """
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        for i in range(batch_size):
            ...
            overlap = self.find_jaccard_overlap(boxes[i],
            ...
            true_locs[i] = self.cxcy_to_gcxgcy(self.xy_to_cxcy(boxes[i][object_for_each_prior]), self.priors_cxcy)  # (8732, 4)
